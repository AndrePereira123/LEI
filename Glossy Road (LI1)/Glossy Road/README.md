...
```bash
$ git clone git@gitlab.com:uminho-di/li1/2223/2022li1g059.git
$ cd 2022li1g059
```
...
```bash
$ git clone https://gitlab.com/uminho-di/li1/2223/projetos/2022li1g059.git
$ cd 2022li1g059
```
...
- **A104275** André Filipe Soares Pereira ;
