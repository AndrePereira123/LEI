...
exports.deletePage = function( id, d ){
    ...
    <body> 
        <div class="w3-card-4">
            <header class="w3-container w3-teal">
                <h1>Aluno com id ${id} foi removido</h1>
            </header>
        </div>
            <footer class="w3-container w3-teal">
                <address>Gerado por galuno::RPCW2022 em ${d} - [<a href="/">Voltar</a>]</address>
...
exports.createdPage = function( id, d ,data){
    var pagHTML = `
    <html>
    <head>
        <title>O Aluno ${id}</title>
    ...
    <body> 
        <div class="w3-card-4">
            <header class="w3-container w3-teal">
                <p>Registo inserido: ${JSON.stringify(data)}
            </header>
        </div>
            <footer class="w3-container w3-teal">
                <address>Gerado por galuno::RPCW2022 em ${d} - [<a href="/">Voltar</a>]</address>
...
exports.editedPage = function( id, d ,data){
    var pagHTML = `
    <html>
    <head>
        <title>O Aluno ${id}</title>
    ...
    <body> 
        <div class="w3-card-4">
            <header class="w3-container w3-teal">
                <p>Registo editada para: ${JSON.stringify(data)}
            </header>
        </div>
            <footer class="w3-container w3-teal">
                <address>Gerado por galuno::RPCW2022 em ${d} - [<a href="/">Voltar</a>]</address>
