...
onMounted(async () => {
  try {
    ...
    allRequests.value = allRequests.value.filter(req => req.response != null)

    console.log('Todos os pedidos:', allRequests.value);
  } catch (err) {
...
const navigateToEnviadasAluno = () => {
  router.push('/aluno/pedidos/enviados');
};
  ...
  <main class="background-container">
    <div class="Caixa_branca">
        <div style="display: flex; flex-direction: row;width: 100%;align-items: center;justify-content: space-evenly;">
            ...
            <button class="ver-enviadas" @click="navigateToEnviadasAluno">Ver pendentes</button>
        </div>
